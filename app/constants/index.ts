...
const projects: {
	...
	platform: "Netlify" | "Vercel" | "Figma" | "Web"
		...
		{
			name: "Vehiql-AI",
			description: "Created a car selling website with AI assistance in searching and finding the car of your choice with AI image search. Functions: Includes Admin functionality for creating and removing cars, EMI calculator , TestDrive bookings, wish list functionality, tracking car bookings with proper authentication for admin users.",
			tags: [
				{
					name: "Nextjs",
			...
			image: "/projectimg/VehiqlAI.png",
			source_code_link: "https://github.com/Priyanshu0202/Vehiql-AI",
			platform: "Vercel",
			deploy_link: "https://vehiql-ai-phi.vercel.app/"
		},
		{
			name: "CodeStack",
			description:
			...
			source_code_link: "https://github.com/Priyanshu0202/code-stack",
			platform: "Vercel",
